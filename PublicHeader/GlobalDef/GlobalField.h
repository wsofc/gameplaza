...
#define DTP_GAME_ID					3								//游戏 I D
#define	DTP_ACCOUNT					5								//帐号
#define	DTP_NICKNAME				7								//昵称
#define	DTP_USER_PWD				9								//用户密码
#define DTP_SEX						11								//用户性别
#define DTP_USER_FACE				13								//用户头像
#define DTP_USER_RIGHT				15								//用户权限
#define DTP_MASTER_RIGHT			17								//管理权限
#define	DTP_UNDER_WRITE				19								//个性签名
#define	DTP_CHARM					21								//用户魅力
#define DTP_MEMBERORDER				22								//会员等级
