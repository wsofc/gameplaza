...
BOOL CXmlNode::SelectSingleNode(LPCWSTR pNodeName, CXmlNode& objXmlNode)
{
...
BOOL CXmlNode::SelectNodes(LPCWSTR pNodeName, CXmlNodeList& objXmlNodeList)
{
...
BOOL CXmlNode::GetFirstChildNode(LPCWSTR pNodeName, CXmlNode& objXmlNode)
{
...
BOOL CXmlNode::GetNextSiblingNode(LPCWSTR pNodeName, CXmlNode& objXmlNode)
{
	IXMLDOMNode * pXMLNode, * pTmpXMLNode;
	BSTR bstrNodeName;
	HRESULT hr;
...
std::wstring CXmlNode::GetAttribute(LPCWSTR lpAttributeName)
{
...
int CXmlNode::GetAttributeInt(LPCWSTR lpAttributeName)
{
...
BOOL CXmlDocument::Load(LPCWSTR pPath)
{
	VARIANT varPath;
...
BOOL CXmlDocument::LoadXml(LPCWSTR pXml)
{
	VARIANT_BOOL isSuccessful = 0;
	BOOL bRet = FALSE;
	HRESULT hr;
...
BOOL CXmlDocument::SelectSingleNode(LPCWSTR pNodeName, CXmlNode& objXmlNode)
{
	IXMLDOMNode * pXMLNode;
	BSTR bstrNodeName;
	HRESULT hr;
...
BOOL CXmlDocument::SelectNodes(LPCWSTR pNodeName, CXmlNodeList& objXmlNodeList)
{
	IXMLDOMNodeList * pXMLNodeList;
	BSTR bstrNodeName;
	HRESULT hr;
