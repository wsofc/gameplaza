...
namespace DuiLib
{
	...
	public:
		...
		void	PaintSepImage(HDC hDC);
		void	PainrSetColor(HDC hDC);
	...
	public:
		...
		// 添加分割线------------------------------------------------------------------
		// Add by Aries 2017/11/23
		virtual void SetSepColor(DWORD dwColor);
		virtual DWORD GetSepColor();
		virtual void SetSepImage(LPCTSTR pStrImage);
		virtual LPCTSTR GetSepImage();
		// ---------------------------------------------------------------------------
