...
#define UISTATE_CAPTURED     0x00000040
	...
	public:
		...
		static void ReloadZipResource(int ID);						// 重新加载zip资源(Add by Aries 2017/12/08 )
		static void ClearResourceZip();								// 清除zip资源内存
		...
		CControlUI* FindNextTabControl(CControlUI* pLastCtl, bool bForward = true);
		...
		DWORD GetAllChildrens(CControlUI* pControl) const;
