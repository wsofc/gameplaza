...
namespace DuiLib
{
	...
	void CContainerUI::SetScrollRange(SIZE szRange)
	{
		if (m_pVerticalScrollBar && m_pVerticalScrollBar->IsVisible()) m_pVerticalScrollBar->SetScrollRange(szRange.cy);
		if (m_pHorizontalScrollBar && m_pHorizontalScrollBar->IsVisible()) m_pHorizontalScrollBar->SetScrollRange(szRange.cx);
	}
